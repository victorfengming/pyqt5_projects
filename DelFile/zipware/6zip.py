...
class Zip_file:
    ...
    def press_file(self):
        ...
        # 提示输入压缩文件名
        file_name = tkinter.simpledialog.askstring(title='获取信息', prompt='给你的新压缩包起个名字吧', initialvalue='demo')
        ...
        for i in set(self.file_list):
            ...
            tkinter.messagebox.showinfo('提示', '压缩文件%s保存成功' % self.des_path + '/' + file_name)
        # print('压缩文件成功')
        zp.close()
        self.clear_file()
